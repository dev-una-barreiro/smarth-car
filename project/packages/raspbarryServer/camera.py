...
xml_face_name = 'data/haarcascade_frontalface_alt.xml'
xml_eye_name = 'data/haarcascade_eye_tree_eyeglasses.xml'
xml_face_path = os.path.join(foderPath, xml_face_name)
xml_eye_path = os.path.join(foderPath, xml_eye_name)
